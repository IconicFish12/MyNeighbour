...
-- DropForeignKey
ALTER TABLE "public"."Booking" DROP CONSTRAINT "Booking_amenityId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Booking" DROP CONSTRAINT "Booking_bookedByUserId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Booking" DROP CONSTRAINT "Booking_residentId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Lease" DROP CONSTRAINT "Lease_residentId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Lease" DROP CONSTRAINT "Lease_unitId_fkey";

-- DropForeignKey
ALTER TABLE "public"."MaintenanceRequest" DROP CONSTRAINT "MaintenanceRequest_assignedToUserId_fkey";

-- DropForeignKey
ALTER TABLE "public"."MaintenanceRequest" DROP CONSTRAINT "MaintenanceRequest_residentId_fkey";
...
-- DropForeignKey
ALTER TABLE "public"."Payment" DROP CONSTRAINT "Payment_processedByUserId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Payment" DROP CONSTRAINT "Payment_residentId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Payment" DROP CONSTRAINT "Payment_unitId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Resident" DROP CONSTRAINT "Resident_unitId_fkey";
